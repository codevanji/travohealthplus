    ...
    <>
      <div id="home" className="hero-section relative px-6 pt-14 lg:px-8 min-h-screen overflow-hidden h-[100vh] bg-hero bg-cover bg-left center bg-no-repeat">
        ...
        <div className="mx-auto max-w-7xl py-20 sm:py-32 lg:py-40">
          ...
          <h1 className="text-5xl md:text-6xl font-semibold leading-tight text-black">
          Your Trusted Partner in Medical Tourism
            </h1>

        
            <br></br><p className="text-lg md:text-xl text-gray-600 font-semibold tracking-wide leading-relaxed text-black">
            ...
            <div className="absolute top-[40%] w-full hidden md:block">
              <div className="max-w-4xl mx-auto flex justify-start items-center gap-4 px-8">
                <div className="w-64"> 
                  <select 
                    value={specialty}
                ...
                {/* Consultation Form */}
                <div className="w-80 bg-white rounded-lg shadow-lg p-6 ml-4">
                  ...
                  <form onSubmit={handleFormSubmit}>
                    <div className="space-y-4">
                      <input
                        ...
                        className="w-full px-4 py-2 rounded-md border border-gray-300 focus:outline-none focus:border-[var(--primary-color)]"
                        required
                      />
                      <input
                        type="email"
                      ...
                      <button
                        type="submit"
                        className="w-full text-white py-3.5 px-6 rounded-full premium-button font-medium tracking-wide shadow-lg"
                      >
            ...
            <div className="absolute top-[40%] w-full md:hidden px-4 z-50">
